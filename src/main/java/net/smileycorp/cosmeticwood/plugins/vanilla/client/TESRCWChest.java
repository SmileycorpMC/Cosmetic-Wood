...
public class TESRCWChest extends TileEntitySpecialRenderer<TileCWChest> {
    ...
    public TESRCWChest() {
        ...
        simpleChest = isChristmas ? new ModelChestCW() : new ModelChest();
        largeChest = isChristmas ? new ModelLargeChestCW() : new ModelLargeChest(); 
    }
	...
	public void render(TileCWChest te, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
        ...
        if (te.adjacentChestZNeg == null && te.adjacentChestXNeg == null)
        {
            ...
            if (modelchest instanceof IColouredChest) {
            	if (((IColouredChest) modelchest).getColour() == null) {
            		((IColouredChest) modelchest).setColour(WoodHandler.getColour(te.getType()));
            	}
            }
